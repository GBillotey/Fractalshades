...
#  * listing files in site-package gmpy2.libs :
# ['gmp.lib', 'libgcc_s_seh-1.dll', 'libgmp-10.dll', 'libmpc-3.dll', 'libmpfr-6.dll', 'libwinpthread-1.dll', 'mpc.lib', 'mpfr.lib']



# print("\n * Adding necessary header files to gmpy2 insatll dir")
# # Currently we store the headers locally ; we could also download them
# # at runtime
...
print("executed, site-package gmpy2.libs content:")
print(os.listdir(gmpy2_libs))

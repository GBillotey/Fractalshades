# -*- coding: utf-8 -*-
"""============================================================================
Auto-generated from fractalshades GUI, version 1.0.4.
...
#        postname = list(plotter.postnames)[i]
#        print("layer debug 417", postname, layer.output)
...
#    for i, layer in enumerate(plotter.layers):
#        postname = list(plotter.postnames)[i]
#        print("layer debug 457", postname, layer.output)
...
#    for i, layer in enumerate(plotter.layers):
#        postname = list(plotter.postnames)[i]
#        print("layer debug", postname, layer.output)

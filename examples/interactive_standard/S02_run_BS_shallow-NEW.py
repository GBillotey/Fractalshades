...
def plot(plot_dir):
    ...
    Example interactive
    """
    fractal = fractal = fsm.Burning_ship(plot_dir)
    shallowzooming = fs.gui.guitemplates.shallowzooming(fractal)
    gui = fs.gui.guimodel.Fractal_GUI(shallowzooming)
    gui.show()
...
#
#
#    gui = fs.gui.guimodel.Fractal_GUI(func)

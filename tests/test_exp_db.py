# -*- coding: utf-8 -*-
"""
This contains the tests for saving a Exponential mapping as adb and plotting
from it
"""
...
class Test_exp_db(unittest.TestCase):
    ...
    def get_plot_kwargs(cls):
        ...
        return {
            ...
            "_1": "Zoom parameters",
            "x": "-1.038481916677644940246125591921637318",
            "y": "0.2835016361820746994217878719892218886",
            "dx": "4.026211595487792e-27",
            "dps": 37,
            "xy_ratio": 1.0,
            "theta_deg": 0.0,
            "nx": 600,
            ...
            "colormap": fs.colors.Fractal_colormap(
                colors=[[0.14901961, 0.37254903, 0.29803923],
                     [0.36078432, 0.90196079, 0.72156864]],
                kinds=['Lch'],
                grad_npts=[32],
                grad_funcs=['x'],
                extent='mirror'
    ...
    def setUpClass(cls):
        ...
        db_dir = os.path.join(test_config.temporary_data_dir, "_EXP_db_dir")
        fs.utils.mkdir_p(db_dir)
        cls.db_dir = db_dir
        cls.calc_name = "test"
...
if __name__ == "__main__":
    ...
    full_test = False
    if full_test:
        runner.run(test_config.suite([Test_exp_db]))
    else:
        suite = unittest.TestSuite()
        suite.addTest(Test_exp_db("test_green"))
